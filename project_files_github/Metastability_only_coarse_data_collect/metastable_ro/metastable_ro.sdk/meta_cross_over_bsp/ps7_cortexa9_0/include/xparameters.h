...
/* Definitions for peripheral COARSE_DELAY_CTRL */
#define XPAR_COARSE_DELAY_CTRL_BASEADDR 0x41210000
#define XPAR_COARSE_DELAY_CTRL_HIGHADDR 0x4121FFFF
#define XPAR_COARSE_DELAY_CTRL_DEVICE_ID 1
#define XPAR_COARSE_DELAY_CTRL_INTERRUPT_PRESENT 0
#define XPAR_COARSE_DELAY_CTRL_IS_DUAL 1


/* Definitions for peripheral FINE_DELAY_CTRL */
#define XPAR_FINE_DELAY_CTRL_BASEADDR 0x41200000
#define XPAR_FINE_DELAY_CTRL_HIGHADDR 0x4120FFFF
#define XPAR_FINE_DELAY_CTRL_DEVICE_ID 2
#define XPAR_FINE_DELAY_CTRL_INTERRUPT_PRESENT 0
#define XPAR_FINE_DELAY_CTRL_IS_DUAL 1
...
/* Canonical definitions for peripheral COARSE_DELAY_CTRL */
#define XPAR_GPIO_1_BASEADDR 0x41210000
#define XPAR_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_COARSE_DELAY_CTRL_DEVICE_ID
#define XPAR_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_GPIO_1_IS_DUAL 1

/* Canonical definitions for peripheral FINE_DELAY_CTRL */
#define XPAR_GPIO_2_BASEADDR 0x41200000
#define XPAR_GPIO_2_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_2_DEVICE_ID XPAR_FINE_DELAY_CTRL_DEVICE_ID
