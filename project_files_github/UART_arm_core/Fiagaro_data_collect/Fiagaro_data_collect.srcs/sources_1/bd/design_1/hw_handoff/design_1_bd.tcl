...
CONFIG.C_PROBE9_MU_CNT {2}  ] $ila_0
  ...
  # Create instance: trng_control_1, and set properties
  set trng_control_1 [ create_bd_cell -type ip -vlnv user.org:user:trng_control:1.0 trng_control_1 ]
  ...
  connect_bd_net -net xlconcat_0_dout [get_bd_pins trng_control_1/shifter_load_data] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xor_gate_Res [get_bd_pins raw_trng/D] [get_bd_pins trng_control_1/trng_bit_in] [get_bd_pins xor_gate/Res]
