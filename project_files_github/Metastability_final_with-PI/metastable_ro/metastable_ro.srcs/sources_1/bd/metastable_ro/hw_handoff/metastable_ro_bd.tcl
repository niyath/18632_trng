...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.AsyncInitVal {0} CONFIG.DefaultData {0} CONFIG.Depth {1} CONFIG.SyncInitVal {0} CONFIG.Width {1}  ] $c_shift_ram_0

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_0 ]
  set_property -dict [ list CONFIG.CLKIN1_JITTER_PS {200.0} CONFIG.CLKOUT1_JITTER {159.601} CONFIG.CLKOUT1_PHASE_ERROR {161.614} CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {150} CONFIG.CLKOUT2_JITTER {175.200} CONFIG.CLKOUT2_PHASE_ERROR {161.614} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {100} CONFIG.CLKOUT2_USED {true} CONFIG.JITTER_SEL {No_Jitter} CONFIG.MMCM_CLKFBOUT_MULT_F {18.000} CONFIG.MMCM_CLKOUT0_DIVIDE_F {6.000} CONFIG.MMCM_CLKOUT1_DIVIDE {9} CONFIG.NUM_OUT_CLKS {2} CONFIG.PRIM_IN_FREQ {50} CONFIG.RESET_TYPE {ACTIVE_LOW}  ] $clk_wiz_0
  ...
  # Create instance: mux_s0_select_LFSR, and set properties
  set mux_s0_select_LFSR [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 mux_s0_select_LFSR ]
  set_property -dict [ list CONFIG.C_SIZE {1}  ] $mux_s0_select_LFSR

  # Create instance: mux_s1_SELECT_RAW, and set properties
  set mux_s1_SELECT_RAW [ create_bd_cell -type ip -vlnv xilinx.com:ip:util_vector_logic:2.0 mux_s1_SELECT_RAW ]
  set_property -dict [ list CONFIG.C_SIZE {1}  ] $mux_s1_SELECT_RAW
  ...
  connect_bd_net -net Op2_2 [get_bd_ports Data_output_select] [get_bd_pins mux_s1_SELECT_RAW/Op2] [get_bd_pins not_s_equals0/Op1]
  ...
  connect_bd_net -net c_shift_ram_0_Q [get_bd_pins PI_controller_0/data_in] [get_bd_pins c_shift_ram_0/Q] [get_bd_pins mux_s1_SELECT_RAW/Op1] [get_bd_pins trng_control_0/trng_bit_in]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins delay_top_0/input_data]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins PI_controller_0/clk] [get_bd_pins bram_control_0/clk] [get_bd_pins c_shift_ram_0/CLK] [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins lfsr_filter_0/clk] [get_bd_pins trng_control_0/clk]
  ...
  connect_bd_net -net delay_top_0_registered_data [get_bd_ports registered_data_LED2_u21] [get_bd_pins c_shift_ram_0/D] [get_bd_pins delay_top_0/registered_data]
  ...
  connect_bd_net -net lfsr_filter_0_s_out [get_bd_pins lfsr_filter_0/s_out] [get_bd_pins mux_s0_select_LFSR/Op1]
  connect_bd_net -net lfsr_or_raw_mux_Res [get_bd_pins bram_control_0/trng_bit_in] [get_bd_pins lfsr_or_raw_mux/Res]
  connect_bd_net -net mux_s0_Res [get_bd_pins lfsr_or_raw_mux/Op1] [get_bd_pins mux_s0_select_LFSR/Res]
  connect_bd_net -net mux_s1_Res [get_bd_pins lfsr_or_raw_mux/Op2] [get_bd_pins mux_s1_SELECT_RAW/Res]
  ...
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins mux_s0_select_LFSR/Op2] [get_bd_pins not_s_equals0/Res]
